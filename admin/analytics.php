...
<script>
    ...
    var xplace=<?php echo json_encode($places); ?>;
    var yValues = [<?php echo json_encode($male, JSON_HEX_TAG);?>, <?php echo json_encode($female, JSON_HEX_TAG);?>, 0]; // Initialize count to 0
